...
async def regenerate_with_correct_kols():
    """重新生成17檔盤中急漲股貼文 - 修復KOL映射問題"""
    ...
    try:
        ...
        print("🔧 修復內容:")
        print("   - KOL nickname正確映射")
        print("   - 平均分配KOL（每個KOL至少分配1-2檔股票）")
        print("   - 使用角色紀錄表的正確名稱")
        print("   - 深度洞察分析")
        print("   - 類股連動分析")
        print("   - 新聞內容總結")
...
if __name__ == "__main__":
    asyncio.run(regenerate_with_correct_kols())
