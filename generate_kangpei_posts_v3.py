...
class KangpeiPostGeneratorV3:
    """康霈生技貼文生成器 V3 - 完整個人化系統 + 正確欄位對應"""
    ...
    async def update_posts_sheet(self, posts: List[Dict[str, Any]]):
        ...
        try:
            ...
            for i, post in enumerate(posts, 1):
                ...
                logger.info(f"內容長度: {post['word_count']} 字 ({post['content_length']})")
    ...
    async def run(self):
        """執行貼文生成流程"""
        logger.info("🚀 開始生成 6919 康霈生技相關貼文 (V3)...")
...
async def main():
    """主函數"""
    generator = KangpeiPostGeneratorV3()
    await generator.run()
