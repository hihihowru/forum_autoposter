...
async def execute_intraday_trigger(request: Request):
    """執行盤中觸發器"""
    try:
        body = await request.json()
        logger.info(f"執行盤中觸發器: {body}")
