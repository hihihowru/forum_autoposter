...
async def startup_event():
    ...
    # Fixed: Added check in schedule_service.py to prevent executing same schedule multiple times per day
    # The scheduler now checks last_run timestamp before executing
    logger.info("🚀 排程服務背景任務已啟用 - 時間檢查邏輯已修復")
    print("🚀 排程服務背景任務已啟用 - 時間檢查邏輯已修復")
