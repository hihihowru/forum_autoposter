...
class PersonalizedPromptGenerator:
    ...
    def __init__(self):
        ...
        # 完整的 KOL 個人化設定（應該從 Google Sheets 讀取）
        self.kol_settings = {
            "200": {  # 川川哥
                "nickname": "川川哥",
                "persona": "技術派",
...
class KangpeiPostGeneratorV2:
    ...
    async def run(self):
        """執行貼文生成流程"""
        logger.info("🚀 開始生成 6919 康霈生技相關貼文 (V2)...")
...
async def main():
    """主函數"""
    generator = KangpeiPostGeneratorV2()
    await generator.run()
